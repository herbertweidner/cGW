...
fGW0=6.3158e-6; %HW95=fGW0*360*3600; optimiert
...
%{
ax=3.72; px=0.677; fx=38.278e-9; D1=0; ww=0; 
ax2=3.516; px2=4.11; fx2=10.972e-9; % C
ax3=0.8965; px3=6.1; fx3=7.3e-10; %Frequenzzähler M
ax4=0; px4=1.885; fx4=8.49e-10; % Frequenzzähler L 
ax5=1.717; px5=1.732; fx5=100.214e-9; % D
ax6=1.8415; px6=1.01; fx6=2.782e-9; % F
ax7=0.838; px7=2.665; fx7=14e-10; % Frequenzzähler  Jahre
ax8=1.48; px8=3.97; fx8=66.732e-9; % 
ax9=0.32; px9=0; fx9=79.3e-9; % E
ax10=0; px10=3; fx10=6.12776e-9; % Jahre
ax11=0; px11=3; fx11=0.98e-9; % H
ax12=0; px12=3; fx12=4.8e-9; % J
ax13=0; px13=3; fx13=1.24e-9; % K
ax14=0; px14=3; fx14=1.6e-10; % Frequenzzähler
ax15=0; px15=0.555; fx15=-8.49e-10; % Frequenzzähler
axJ=1.92; pxJ=4.87; fxJ=31.688e-9; %31.688 nHz
%}
ax=5.7218; px=4.557; fx=39.2551e-9; D1=35.53; ww=-9.21e-05; phas=-0.81158;
ax2=2.6521; px2=2.871; fx2=12.0251e-9; % C
ax3=1.442; px3=1.692; fx3=9.4584e-10; %Frequenzzähler M
ax4=0; px4=4.8; fx4=12.2e-10; % Frequenzzähler L 
ax5=4.896; px5=4.7237; fx5=4.1865e-9; % D
ax6=0; px6=3.22; fx6=3.915e-9; % F
ax7=1.5952; px7=0.6712; fx7=12.3575e-10; % Frequenzzähler  Jahre
ax8=1.9917; px8=1.9584; fx8=57.5098e-9; % 
...
axJ=3.383; pxJ=0.074; fxJ=32.3021e-9; %31.69 nHz
...
R=zeros(5950,52); erg=zeros(4,2); Limi=-11; k3alt=1; z0=zeros(400,3); 
for k3=1:5950
...
else, D1=erg(3,1)+erg(3,2)*900;
end
    
    if k3>20, ww=ww-mean(R(max(10,k3-30):k3,31))/5; disp(ww),end
